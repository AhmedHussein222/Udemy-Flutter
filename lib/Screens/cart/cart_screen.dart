  ...
  Future<void> _checkoutItem(BuildContext context, DocumentReference cartRef, Map<String, dynamic> item) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Are you sure you want to complete the payment for this course?'),
        actions: [
          TextButton(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () => _checkoutItem(context, cartRef, item),
                                child: const Text('Checkout', style: TextStyle(color: Colors.purple, fontSize: 16)),
                              ),
                            ],
                          ),
                        ],
